...
int main(int argc, char * argv[])
{
	...
	CameraRGBDImages camera("/home/rahul/dataset6sem/classroom_testrun1/mono/", "/home/rahul/dataset6sem/classroom_testrun1/depth/");
	...
	for(int i=0;i<6; ){
		...
		if(ch=='y'){
			...
			rgb.convertTo(rgb,CV_8UC3);
	    		...
	    		cv::waitKey(1);
			if(i==0){
				std::string filename = "/home/rahul/rtabmap_project/SvmCall.py";
				std::string command = "python ";
				command += filename;
				system(command.c_str());
				filename = "/home/rahul/Documents/proooo/project_29/HoG.py";
				command = "python ";
				command += filename;
				system(command.c_str());
			}
