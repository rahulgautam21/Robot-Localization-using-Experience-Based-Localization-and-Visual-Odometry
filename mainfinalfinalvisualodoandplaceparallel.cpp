...
int main(int argc, char * argv[])
{
	...
	CameraRGBDImages camera("/home/rahul/dataset6sem/dynamic_testRun_classRoom/mono/", "/home/rahul/dataset6sem/dynamic_testRun_classRoom/depth/");
...
*/
	...
	while(frame.isValid())
	{	
	   myfile1.open("Visualdynamicsresultsplace.txt",std::ofstream::app);
	   myfile2.open("Visualdynamicsresultsodo.txt",std::ofstream::app);
